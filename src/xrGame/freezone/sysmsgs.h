...
typedef FZDllModFunResult(__stdcall* FZDllModFun)(const char* procarg1, const char* procarg2);
...
public:
    ...
    void SendModDownloadMessage(const char* mod_name, const  char* mod_params, FZSysMsgSendCallback cb, void* userdata)
    {
